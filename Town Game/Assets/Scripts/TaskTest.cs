...
public class TaskTest : MonoBehaviour
{
    ...
    private void Update()
    {
        if (Input.GetKeyDown(KeyCode.Alpha0)) currentTaskId = jobHandler.AddTask("Do the dishes by <deadline>", FindAnyObjectByType<GameManager>().currentPeriod + 3f, Vector3.zero);
